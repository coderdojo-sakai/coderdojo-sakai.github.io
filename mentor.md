...
<div class="row coderdojobgcolor-base2">
  ...
  <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
    <img src="{{ HOME_PATH }}images/mentor001.jpg" alt="CoderDojo堺" class="img-responsive img-rounded center-block imageshadow" style="width:100%">
    <br>
  </div>
...
<div class="row">
  <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1"></div>
  <div class="col-xs-12 col-sm-12 col-md-4 col-md-push-6 col-lg-4 col-lg-push-6">
    <br>
    <img src="{{ HOME_PATH }}images/mentor002.png" alt="CoderDojo堺" class="img-responsive img-rounded center-block imageshadow" style="width:100%">
    <br>
  </div>
  <div class="col-xs-12 col-sm-12 col-md-6 col-md-pull-4 col-lg-6 col-lg-pull-4 text-left">
    ...
    <h4>
      ...
      であれば構いません。<br>
      <br>
      ただし、Dojoは堺市近辺で行いますので、堺市近辺にご在住の方のみとさせて頂きます。<br>
      <br>
